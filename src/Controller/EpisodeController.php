...
class EpisodeController extends AbstractController
{
    ...
    public function new(Request $request, EpisodeRepository $episodeRepository, MailerInterface $mailer, SluggerInterface $slugger): Response
    {
        $episode = new Episode();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $email = (new Email())
                ...
                ->subject('Un nouvau épisode vient d\'être publiée !')
    ...
    public function edit(Request $request, Episode $episode, EpisodeRepository $episodeRepository, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $episode->setSlug($slug);
            $episodeRepository->save($episode, true);
            $this->addFlash('success', 'The episode has been add');
    ...
    public function delete(Request $request, Episode $episode, EpisodeRepository $episodeRepository): Response
    {
        if ($this->isCsrfTokenValid('delete' . $episode->getId(), $request->request->get('_token'))) {
            ...
            $this->addFlash('danger', 'The episode has been delete');
        }
